...
static const CGFloat kUITextViewVerticalPadding = 8;
...
- (void)layoutSubviews {
  ...
  _textView.frame = CGRectOffset(TTRectContract(frame, 4, 10), 4, 7);
  _textField.frame = CGRectOffset(TTRectContract(frame, 12, 14), 12, 7);
}
